    ...
    <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-12">
      <div className="flex flex-col lg:items-center lg:flex-row xl:max-w-6xl xl:mx-auto">
        ...
        <div className="lg:w-1/2">
          <p>
          Money is a social construct. It only has value because we have all agreed to give it value. Its a tool we use to exchange goods and services, but its not the only tool. There are many other ways to create value, and many other forms of currency, such as time, attention, and relationships.
          </p>
        </div>
      </div>
    </div>
